 ...
 */
export interface IPropertyField{ComponentName}Props {
    /**
...
export interface IPropertyField{ComponentName}PropsInternal extends IPropertyField{ComponentName}Props, IPropertyPaneCustomFieldProps {
